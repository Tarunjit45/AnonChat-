...
export const Header: React.FC<HeaderProps> = ({ onlineCount, category, onLeave }) => {
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-surface/90 backdrop-blur-md border-b border-white/5 flex items-center justify-between px-4 z-50 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
           ...
           <div>
             ...
             <p className="text-[10px] text-zinc-400 font-medium">AnonChat</p>
           </div>
        </div>
      </div>
